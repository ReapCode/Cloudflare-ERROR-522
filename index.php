...
##
Selling this site is prohibited
Using the website is at your own risk
Selling this site is prohibited
Using the website is at your own risk
-->

<head> <!-- Your Domain OTHER Your Server IP - Adresse -->
    <title>YOUR DOMAIN | 522: Connection timed out</title>
    <meta charset="UTF-8">
    ...
    <div id="cf-error-details" class="cf-error-details-wrapper">
        <div class="cf-wrapper cf-error-overview">
            <h1>
                ...
                <small class="heading-ray-id">Ray ID: <?php echo bin2hex(mcrypt_create_iv(8, MCRYPT_DEV_URANDOM)); ?> • 2019-04-14 22:06:00 UTC</small>
            </h1>
        ...
        <div class="cf-error-footer cf-wrapper">
            <p>
                <span class="cf-footer-item">Cloudflare Ray ID: <strong><?php echo bin2hex(mcrypt_create_iv(8, MCRYPT_DEV_URANDOM)); ?></strong></span>
                <span class="cf-footer-separator">•</span>
                <span class="cf-footer-item"><span>Your IP</span>: <?php echo $_SERVER['REMOTE_ADDR']; ?></span>
                <span class="cf-footer-separator">•</span>
